...
<?php
	...
	$style_class = 'bg-dark-alfa-50';

	$subtitle_class = '';

	$background = ts_get_opt('article-title-wrapper-background'); //@TODO change this for my own option loaded to artykuly type
	$background_data = '';
	$add_bg = false;
		...
		<div class="<?php echo sanitize_html_classes($container_class); ?> container">
			<div class="row">
				<div class="col-md-8 align-left">
					...
					<?php $subtitle = ts_get_post_opt('article-title-wrapper-subtitle-local'); //@TODO make this own option
					if (!empty($subtitle)): ?>
