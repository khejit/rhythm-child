...
(function($){
    ...
    function init_classic_menu(){
        ...
        $(window).scroll(function(){
                ...
                if ($('.logo.small-height img').height() > $('.main-nav.small-height').height() && $(window).scrollTop() > 10) {
                    $('.logo.small-height img').height( $('.main-nav.small-height').height() )
                }
...
jQuery(function(){
   jQuery('.type-articles h2.section-title:first-child').prepend('<i class="fa fa-leaf">&nbsp;</i>');
});

(function magicznyContentList($){
    $('.magiczny-spis-tresci').each(
        function(){
            ...
            links.each(
                ...
                function(){
                    ...
                    $(this).on('click', function(e){
                        ...
                        goTo = $(id).offset().top - selectorHeight - 10;
